 ...
 * @document UserTransferAmountWebService.java
 * @author Rahul Mahajan
 * @version 1.0
 * @date 18/11/2012
 */
public class UserTransferAmountWebService extends WebService<WsModel>{

	public UserTransferAmountWebService(Map<String, String> params)
	{ 
		super(params);  
	}
	@Override    
	protected String getURL() {  
		    return getWsUrl("ws.transferAmount");   
	}         
