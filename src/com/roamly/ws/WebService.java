...
//						+ " for URL " + request.getURI());
	...
	/**
	 * Add By Rahul Mahajan Date 06/10/2012
	...
	public String getWsUrl(String key) 
	{
		...
		java.net.URL url = Config.class.getClassLoader().getResource("messages_ws_url.properties");
		try
		{  
		...
		System.out.println("url-------"+prop.getProperty(key).trim());
